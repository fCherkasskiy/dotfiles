#!/usr/bin/env zsh
# Generated by Powerlevel10k configuration wizard on 2026-04-02 at 21:24 EDT.
...
() {
  ...
  # typeset -g TEMP="${CONDA_PREFIX:t}"
  # typeset -g TEMP="${${CONDA_PREFIX:t}:#(default|base)}"
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION="${${CONDA_PREFIX:t}:#(default|base)}"
  #
